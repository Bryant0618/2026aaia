// week06-1 好玩的程式設計 ..... File-Preference 調大字型
// 修改自 week05-2 好玩的程式設計 兩層for迴圈 配合 if .. else if .. else
void setup() {
...
void draw() {
for (int i=0; i<10; i++) { // 上週是 for y 現在改成 for i 左手
for (int j=0; j<16; j++) { // 上週是 for x 現在改成 for j 右手
